...
(lib.label1 = function() {
	...
	// Layer 1
	this.text_5 = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_osi_2txt01", width:"175", expand:"up+down"});
    this.text_5.setTransform(325,202);

	this.text_6 = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_osi_2txt02", width:"175", expand:"up+down"});
	this.text_6.setTransform(325,168);

 	this.text_7 = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_osi_2txt03", width:"175", expand:"up+down"});
	this.text_7.setTransform(325,135);
	
 	this.text_8 = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_osi_2txt04", width:"175", expand:"up+down"});
	this.text_8.setTransform(313,102);

 	this.text_9 = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_osi_2txt05", width:"175", expand:"up+down"});
	this.text_9.setTransform(325,70);

 	this.text_10 = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_osi_2txt06", width:"175", expand:"up+down"});
	this.text_10.setTransform(306,36);

 	this.text_11 = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_osi_2txt07", width:"175", expand:"up+down"});
	this.text_11.setTransform(318,0);

 	this.text_12 = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_osi_1txt01", width:"175", expand:"up+down"});
	...
	this.text_17.setTransform(-5,35.4);
 	...
 	this.text_18 = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_osi_1txt07", width:"175", expand:"up+down"});
