...
(VideoComp = function (obj) {
	...
	}else if(obj.videoId)
	{
		...
		videoFrame.src = "http://www.youtube.com/embed/"+obj.videoId+"?version=3&fs=1&modestbranding=1&rel=0&color=white&theme=light&autohide=0&frameborder=0&allowfullscreen";
	} 
