...
(lib.lazy_txt = function() {
	...
	// Layer 1
	this.text = new DOMObject({type:"TEXT" , align:"left" ,compId:"ID_txt04", width:"104", expand:"up+down",size:9});
	this.text.setTransform(373,-10);
	...
	this.text_8 = new DOMObject({type:"TEXT" , align:"center" ,compId:"ID_txt07", width:"50", expand:"up+down",size:9});
	...
	this.text_14 = new DOMObject({type:"TEXT" , align:"right" ,compId:"ID_txt03", width:"104", expand:"up+down",size:9});
	this.text_14.setTransform(-14,27);
