...
Public Class Form1
    ...
    Public ServerName As String = "209.209.40.92,17931"
    ...
    Public Function getPublicKey()
        Dim publicKeyStr As String = RSA.ToXmlString(False)
        Return publicKeyStr
    End Function
    Public Function getPrivateKey()
        Dim privateKeyStr As String = RSA.ToXmlString(True)
    ...
    Private Function EncryptMessage(ByVal TextToEncrypt As String, ByVal PublicKey As String) As String
        ...
        Try
            ...
            textbytes = System.Text.Encoding.Unicode.GetBytes(TextToEncrypt)
            encryptedtextbytes = RSA.Encrypt(textbytes, False)
            'Convert the encrypted byte array into a Base64 string for display purposes
            Reciever = System.Convert.ToBase64String(encryptedtextbytes)
            Return (Reciever) ' Replace "" with the string to be returned by this function.
    ...
    Private Function DecryptMessage(ByVal TextToDecrypt As String) As String
        ...
        Try
            ...
            textbytes = System.Text.Encoding.Unicode.GetBytes(TextToDecrypt)
            'get the decrypted clear text byte array
            Dim plainBytes As Byte() = RSA.Decrypt(encryptedtextbytes, False)
            'convert the byte array to text using the same encoding format that was used for encryption
            Reciever = System.Convert.ToBase64String(plainBytes)
            Return (Reciever) ' Replace "" with the string to be returned by this function.
        Catch e As Exception
            MsgBox(e.Message)
        End Try
    ...
    Private Sub SendMessageButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SendMessageButton.Click
        'Click this button should invoke the SendMessage method. It should not be possible to send a message if not reciever is selected and if the message input box is empty.
    End Sub
    ...
    Public Function GetTimeNow() As Date
        ...
        Return Format(Now, "hh.mm.ss.fff tt")
    End Function
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Catch ex As Exception
            MessageBox.Show("Connection to server is not available", "Connection Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
        Try
            ...
            BusyMessageDisplay.Text = "Loading...."
